...
class Cart:
    ...
    def __init__(self,request):
        self.session = request.session #Создаем сессию
    ...
    def add(self, product, quantity=1, update_quantity = False):
        ...
        if update_quantity:
            self.cart[product_id]['quantity'] = quantity # Количество 1 товара
        else:
            self.cart[product_id]['quantity'] += quantity #Общее количество добавляемого товара в корзину
        self.save()
